//Cria um array de objetos chamado "produtos" que armazena as informações: ID, nome, professor, preço, descrição e imagem.
const produtos = [
    {
        id: "1",
    ...
    // Cria uma função chamada renderizaProdutos().
    function renderizaProdutos(){
        // Declara a variavel para armazenar o HTML.
        let html = "";

        // Itera sobre o array de produtos.
        for (let i = 0; i < produtos.length; i++) {

            // Chama a função `criaProduto()` para gerar o HTML para um produto.
    ...
    // Está criando uma função chamada criaProduto, criando uma representação HTML para um produto.
    function criaProduto(produto, index) {

        // Retorna uma string que contém HTML.
        // Cria uma div com uma classe chamada curso.
        // Cria uma imagem 
        ...
        // Está criando uma classe chamada preco-de que está chamando a propriedade preco_de do objeto produto.
        // Está criando uma classe chamada preco-por que está chamando a propriedade preco_por do objeto produto.
    ...
    // Cria um objeto chamado container que chama o id da pagina HTML.
    const container = document.querySelector('#container')

    // Atribui o resultado da função renderizaProdutos() ao innerHTML com o ID "container". 
    ...
    // Cria uma função chamada criaItemCarrinho chamando a variavel produto.
    function criaItemCarrinho(produto) {

        // Retorna uma string que contém HTML.
        // Cria uma div com uma classe chamada carrinho_compra.
        //  Inseri o nome do produto com a tag h4.
        // Inseri o preço da unidade e a quantidade.
    ...
    function criaCarrinhoTotal() {
        ...
        // Cria uma variavel local de valor 0.
        let total = 0;
        ...
        // Seleciona o elemento HTML com a classe "carrinho_total" usando o document.querySelector().
        // Em seguida, atualiza o innerHTML com uma string de HTML.
        // Inseri o valor total dos produtos ao carrinho.
        // Cria um link com um href vazio e abre em uma nova aba.
        // Inseri um icone de cartão de crédito.
    ...
    // Cria uma função chamada adicionaItemNoCarrinho chamando o obejeto produto.
    function adicionaItemNoCarrinho(produto) {

        // Verifica se o produto ainda não existe no carrinho, está verificando se a propriedade produto.id não está presente no objeto carrinhoItens.
    ...
    document.body.addEventListener('click', function (event) {
        ...
        //verifica se o elemento clicado possui a classe "btn-add", usando o método classList.contains().
        // Se o elemento tiver essa classe, significa que o botão "Adicionar ao Carrinho" foi clicado.
        ...
        if (elemento.classList.contains('btn-remove')){
            ...
            // Verifica se a quantidade desse produto no carrinho é menor ou igual a 1. Se for, o produto é removido do carrinho usando delete carrinhoItens[produtoId]. 
            //Caso contrário, a quantidade é decrementada em 1.
